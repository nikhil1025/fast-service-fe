    ...
    >
      <div className="container-custom">
        ...
        {cleaningServices.length > 0 ? (
          <div className="relative group">
            {/* Prev Button */}
            <button className="cleaning-swiper-prev absolute left-1 sm:left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 bg-white backdrop-blur rounded-full shadow-lg flex items-center justify-center text-gray-800 hover:text-white hover:bg-primary transition-all duration-200 opacity-0 group-hover:opacity-100">
              <ChevronLeft size={18} className="sm:size-20" />
            </button>

            {/* Next Button */}
            <button className="cleaning-swiper-next absolute right-1 sm:right-0 top-1/2 -translate-y-1/2 translate-x-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 bg-white backdrop-blur rounded-full shadow-lg flex items-center justify-center text-gray-800 hover:text-white hover:bg-primary transition-all duration-200 opacity-0 group-hover:opacity-100">
