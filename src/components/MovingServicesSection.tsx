      ...
      <div className="container-custom">
        ...
        <div className="flex flex-row sm:items-center justify-between mb-6 sm:mb-8 gap-4">
          ...
          <Link
            href={
              movingCategory
                ? `/services/category/${movingCategory.slug}`
                : "/services"
            }
